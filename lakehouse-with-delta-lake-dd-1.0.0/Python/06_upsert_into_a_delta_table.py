...
# MAGIC The transaction log tells the Delta reader which file to use for each record.06
...
# MAGIC 
# MAGIC 
# MAGIC Let’s sum the records in the `broken_readings` view once more. Note that there are still broken readings in the table.
# MAGIC 
...
# MAGIC 
# MAGIC 
# MAGIC **NOTE:** It is not necessary to redefine the view `broken_readings`.
...
# MAGIC 
# MAGIC 
# MAGIC Finally, there are no more broken readings in the table.
